...
class PostureDialog(QtWidgets.QDialog):
    def __init__(self, parent=MaxPlus.GetQMaxMainWindow()):
        ...
        self.setWindowTitle('Posture - v1.2 beta')
    ...
    def start(self):
        self.ui.pte_reports.appendHtml(
            '''<p><span style="color:white" style="font-size:16px"> Welcome to #Posture v1.2 beta</span></p>''')
    ...
    def define_variables(self):
        ...
        # Define Icons
        self.save_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'save.png'))
        self.folder_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'folder.png'))
        self.geometry_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'geometry.png'))
        self.shape_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'shape.png'))
        self.camera_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'camera.png'))
        self.helper_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'helper.png'))
        self.light_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'light.png'))
        self.spacewarp_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'spacewarp.png'))
        self.profile_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'profile.png'))
        self.posture_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'posture.png'))
        self.instagram_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'instagram.png'))
        self.cancel_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'cancel.png'))
        self.cgcenter_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'cgcenter.png'))

        self.telegram_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'telegram.png'))
        self.gumroad_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'gumroad.png'))
        self.youtube_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'youtube.png'))
        self.facebook_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'facebook.png'))
        self.artstation_icon = QtGui.QIcon(
            os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'artstation.png'))
        self.twitter_icon = QtGui.QIcon(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Icons', 'twitter.png'))
    ...
    def init_UI(self):
        ...
        lay.setMargin(0)
        script_dir = mxs.getDir(mxs.name('scripts'))
        ui_file = QFile(os.path.join(script_dir, 'Startup', 'posture_v1.2', 'Interface', 'user-interface.ui'))
